...
export const transactionToRow = (t: Omit<Transaction, 'id'>) => ({
  ...
  receipt_file_url: t.receiptFileUrl ?? null,
  contract_file_url: t.contractFileUrl ?? null,
  w9_file_url: t.w9FileUrl ?? null,
  contracted_services_file_url: t.contractedServicesFileUrl ?? null,
  conflict_of_interest_file_url: t.conflictOfInterestFileUrl ?? null,
  reconciled_at: t.reconciledAt ?? null,
  no_receipt_acknowledged: t.noReceiptAcknowledged ?? null,
  exemption_form_url: t.exemptionFormUrl ?? null,
});
