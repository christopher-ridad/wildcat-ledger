    ...
    <div className="wl-register-root">
      <div className="wl-register-card wl-privacy-card">
        ...
        <p>
          ...
          organizations. This page explains, in plain terms, what data the app collects
          and how it&apos;s handled. If anything here is unclear, email{' '}
        ...
        <p>
          WildcatLedger doesn&apos;t have its own passwords. Signing in goes through
          Google, restricted to <code>@u.northwestern.edu</code> accounts, which shares
          your name and email address with the app. Beyond that, WildcatLedger only stores
          what you or your organization&apos;s officers and SOFO approvers enter directly
          into the ledger, including transaction records, budget line allocations, and any
          receipt or supporting-document files uploaded for a transaction. Nothing is
          collected passively, and there&apos;s no analytics or tracking script on this
          site.
        </p>
        ...
        <p>
          ...
          approvers you&apos;ve listed can see its transactions, budgets, and files.
        ...
        <p>
          ...
          uses Google only to verify who you are at sign-in. Neither is given your data
          for any purpose beyond running the app.
        </p>
