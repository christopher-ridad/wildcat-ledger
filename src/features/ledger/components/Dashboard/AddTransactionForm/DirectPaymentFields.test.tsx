...
describe('DirectPaymentFields', () => {
  ...
  test('does not show the Special Pay Form by default', () => {
    render(
      <DirectPaymentFields
        form={initialForm}
        isEditing={false}
    ...
    expect(screen.queryByText('Special Pay Form')).not.toBeInTheDocument();
  });

  test('reveals the Special Pay Form for Northwestern employees', () => {
    render(
      <DirectPaymentFields
        form={{ ...initialForm, isNorthwesternEmployee: true }}
        isEditing={false}
        requestedDocTypes={new Set()}
        onChange={vi.fn()}
        onRequestDocument={vi.fn()}
  ...
  test('toggling the Northwestern-employee checkbox calls onChange', () => {
    const onChange = vi.fn();
    render(
      <DirectPaymentFields
        form={initialForm}
  ...
  test('shows the existing Special Pay Form link when editing', () => {
    render(
      <DirectPaymentFields
        form={{ ...initialForm, isNorthwesternEmployee: true }}
        isEditing
