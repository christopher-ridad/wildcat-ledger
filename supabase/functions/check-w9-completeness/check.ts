// The actual W-9 completeness logic, split out from index.ts so it can be
// unit tested (see check.test.ts) against synthetic fixtures instead of
// only ever being exercised by a real, billed Document AI call.
//
...
export const FALLBACK_BOXES: Record<string, Box> = {
...
export const TAX_CLASSIFICATION_CHECKBOXES = [
